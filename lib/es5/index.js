            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        sessionFacade = new SessionFacade_1.SessionFacade(context);
                        return [4 /*yield*/, sessionFacade.trackSession()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
