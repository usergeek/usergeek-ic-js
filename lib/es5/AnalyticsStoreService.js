    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, handleGetAnalyticsReceiverApi(getApiActor, sessionContext.clientPrincipal, sdkVersion, accessToken)];
            case 1:
                handleGetAnalyticsReceiverApiResponse = _a.sent();
                if (!(0, utils_1.isOk)(handleGetAnalyticsReceiverApiResponse)) return [3 /*break*/, 8];
                ...
                return [4 /*yield*/, isCollectRequired(actor, sessionContext.clientPrincipal, sdkVersion, accessToken)];
            case 2:
                handleIsCollectRequiredResponse = _a.sent();
                if (!(0, utils_1.isOk)(handleIsCollectRequiredResponse)) return [3 /*break*/, 6];
                if (!handleIsCollectRequiredResponse.ok.isCollectRequired) return [3 /*break*/, 4];
                return [4 /*yield*/, handleCollect(actor, sessionContext.clientPrincipal, sdkVersion, accessToken)];
            case 3:
                handleCollectResponse = _a.sent();
                if ((0, utils_1.isOk)(handleCollectResponse)) {
                    return [2 /*return*/, (0, utils_1.createOkResult)("collected")];
                }
                else if ((0, utils_1.isErr)(handleCollectResponse)) {
                    return [2 /*return*/, handleCollectResponse];
                }
                return [3 /*break*/, 5];
            case 4: return [2 /*return*/, (0, utils_1.createOkResult)("alreadyCollected")];
            case 5: return [3 /*break*/, 7];
            case 6:
                if ((0, utils_1.isErr)(handleIsCollectRequiredResponse)) {
                    return [2 /*return*/, handleIsCollectRequiredResponse];
                }
                _a.label = 7;
...
var handleGetAnalyticsReceiverApi = function (actor, clientPrincipal, sdkVersion, accessToken) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, actor.getAnalyticsReceiverApi([clientPrincipal], sdkVersion, accessToken)];
            case 1:
                result = _a.sent();
                return [3 /*break*/, 3];
            case 2:
            ...
            case 3:
                ...
                if ((0, utils_1.isOk)(result)) {
                    ...
                    return [2 /*return*/, (0, utils_1.createOkResult)(apiPrincipal)];
                }
...
var isCollectRequired = function (actor, clientPrincipal, sdkVersion, accessToken) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, actor.isCollectRequired([clientPrincipal], sdkVersion, accessToken)];
            case 1:
                result = _a.sent();
                return [3 /*break*/, 3];
            case 2:
            ...
            case 3:
                ...
                if ((0, utils_1.isOk)(result)) {
                    return [2 /*return*/, (0, utils_1.createOkResult)({ isCollectRequired: result.ok })];
                }
                else if ((0, utils_1.isErr)(result)) {
                    error = result.err;
                    if ((0, utils_1.isErrTemporarilyUnavailable)(error)) {
...
var handleCollect = function (actor, clientPrincipal, sdkVersion, accessToken) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, actor.collect([clientPrincipal], sdkVersion, accessToken)];
            case 1:
                result = _a.sent();
                return [3 /*break*/, 3];
            case 2:
