...
var analyticsStore_1 = require("./canister/analyticsStore/analyticsStore");
var utils_1 = require("./utils");
var agent_1 = require("@dfinity/agent");
var getResult = function (sdkVersion, apiKey, clientPrincipal, canisterPrincipal, accessToken) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                getApiActor = (0, analyticsStore_1.createCanisterActor)(canisterPrincipal.toText(), new agent_1.AnonymousIdentity());
                return [4, handleGetAnalyticsReceiverApi(getApiActor, clientPrincipal, sdkVersion, accessToken)];
            case 1:
                ...
                actor = (0, analyticsStore_1.createCanisterActor)(apiPrincipal.toText(), new agent_1.AnonymousIdentity());
                return [4, isCollectRequired(actor, clientPrincipal, sdkVersion, accessToken)];
            case 2:
                ...
                return [4, handleCollect(actor, clientPrincipal, sdkVersion, accessToken)];
            case 3:
