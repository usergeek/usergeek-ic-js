    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4, handleGetAnalyticsReceiver(actor, sessionContext.clientPrincipal, sdkVersion, sessionContext.apiKey)];
            case 1:
            ...
            case 2:
                ...
                return [3, 7];
            case 3: return [4, handleRegisterClient(actor, sessionContext.clientPrincipal, sdkVersion, sessionContext.apiKey)];
            case 4:
