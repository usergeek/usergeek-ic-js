...
var getResult = function (sdkVersion, sessionContext, clientRegistryPrincipal) { return __awaiter(void 0, void 0, void 0, function () {
    var actor, handleGetAnalyticsReceiverResponse, analyticsReceiverView, _a, handleRegisterClientResult;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                actor = (0, clientRegistry_1.createCanisterActor)(clientRegistryPrincipal.toText(), new agent_1.AnonymousIdentity(), sessionContext.host);
                return [4 /*yield*/, handleGetAnalyticsReceiver(actor, sessionContext.clientPrincipal, sdkVersion, sessionContext.apiKey)];
            case 1:
                ...
                if (analyticsReceiverView) {
                    return [2 /*return*/, (0, utils_1.createProceedResult)(analyticsReceiverView)];
                }
                return [3 /*break*/, 8];
            case 2:
                ...
                return [3 /*break*/, 7];
            case 3: return [4 /*yield*/, handleRegisterClient(actor, sessionContext.clientPrincipal, sdkVersion, sessionContext.apiKey)];
            case 4:
                ...
                if ((0, utils_1.isOk)(handleRegisterClientResult)) {
                    return [2 /*return*/, (0, utils_1.createOkResult)("registered")];
                }
...
var handleGetAnalyticsReceiver = function (actor, clientPrincipal, sdkVersion, apiKey) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, actor.getAnalyticsReceiver([clientPrincipal], sdkVersion, apiKey)];
            case 1:
                result = _a.sent();
                return [3 /*break*/, 3];
            case 2:
...
var handleRegisterClient = function (actor, clientPrincipal, sdkVersion, apiKey) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                return [4 /*yield*/, actor.registerClient([clientPrincipal], sdkVersion, apiKey)];
            case 1:
                result = _b.sent();
                return [3 /*break*/, 3];
            case 2:
