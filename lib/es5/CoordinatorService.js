...
var coordinator_1 = require("./canister/coordinator/coordinator");
var Storage_1 = require("./Storage");
var utils_1 = require("./utils");
var ClientRegistryService_1 = require("./ClientRegistryService");
var SessionFacade_1 = require("./SessionFacade");
var coordinator_canister_ids = process.env["COORDINATOR_CANISTER_IDS"] || ["r5m4o-xaaaa-aaaah-qbpfq-cai", "3vhcz-7yaaa-aaaah-qbr2q-cai"];
...
var getResult = function (sdkVersion, apiKey, clientPrincipal) { return __awaiter(void 0, void 0, void 0, function () {
    var canisterIds;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, Storage_1.UGStorage.coordinator.getTopologyId()];
            case 1:
                currentSessionTopologyId = _a.sent();
                return [4, Storage_1.UGStorage.coordinator.getCanisterIds()];
            case 2:
                canisterIds = _a.sent();
                ...
                return [4, getClientRegistry(sdkVersion, apiKey, clientPrincipal, canisterIds)];
            case 3: return [2, _a.sent()];
        }
    });
}); };
exports.getResult = getResult;
var hello = function (sdkVersion, apiKey, clientPrincipal, canisterId) { return __awaiter(void 0, void 0, void 0, function () {
    var actor, topologyId;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                actor = (0, coordinator_1.createCanisterActor)(canisterId, new agent_1.AnonymousIdentity());
                topologyId = currentSessionTopologyId;
                return [4, actor.hello([clientPrincipal], sdkVersion, topologyId ? [topologyId] : [], apiKey)];
            case 1: return [2, _a.sent()];
        }
    });
}); };
var getClientRegistry = function (sdkVersion, apiKey, clientPrincipal, inProgressCanisterIds) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!canisterId) return [3, 6];
                result = void 0;
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4, hello(sdkVersion, apiKey, clientPrincipal, canisterId)];
            case 2:
                result = _a.sent();
                return [3, 4];
            case 3:
            ...
            case 4:
                ...
                if ((0, utils_1.hasOwnProperty)(result, "clientRegistry")) {
                    ...
                    if (clientRegistryPrincipal) {
                        return [2, (0, utils_1.createProceedResult)({ clientRegistry: { canisterPrincipal: clientRegistryPrincipal } })];
                    }
                }
                    ...
                    if (analyticsReceiverView) {
                        return [2, (0, utils_1.createProceedResult)({ analyticsReceiver: { view: analyticsReceiverView } })];
                    }
                }
                else if ((0, utils_1.hasOwnProperty)(result, "collectSuccess")) {
                    return [2, (0, utils_1.createOkResult)("collectSuccess")];
                }
                    ...
                    return [2, (0, utils_1.createErrResult)("changeTopology")];
                }
            ...
            case 5:
                ...
                return [2, getClientRegistry(sdkVersion, apiKey, clientPrincipal, updatedInProgressCanisters)];
            case 6: return [2, (0, utils_1.createErrRetry)()];
        }
    });
}); };
