    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4, getClientRegistry(sdkVersion, sessionContext, canisterIds)];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4, actor.hello([sessionContext.clientPrincipal], sdkVersion, topologyId ? [topologyId] : [], sessionContext.apiKey)];
...
var getClientRegistry = function (sdkVersion, sessionContext, inProgressCanisterIds) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4, hello(sdkVersion, sessionContext, canisterId)];
            case 2:
                result = _a.sent();
                return [3, 4];
            case 3:
            ...
            case 5:
                ...
                return [2, getClientRegistry(sdkVersion, sessionContext, updatedInProgressCanisters)];
