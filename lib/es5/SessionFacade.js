...
var SessionFacade = (function () {
    function SessionFacade(apiKey, principal) {
        this.apiKey = apiKey;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4, this.recursiveCall(sdkVersion, GLOBAL_RETRIES)];
                    case 1:
                        result = _a.sent();
    ...
    SessionFacade.prototype.recursiveCall = function (sdkVersion, retriesLeft) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4, this.recursiveCallCoordinator(sdkVersion, COORDINATOR_RETRIES)];
                    case 1:
                        coordinatorResponse = _b.sent();
                        (0, utils_1.log)("recursive.callCoordinator", coordinatorResponse);
                        if (!(0, utils_1.isOk)(coordinatorResponse)) return [3, 2];
                        return [2, coordinatorResponse.ok];
                    case 2:
                        if (!(0, utils_1.isProceed)(coordinatorResponse)) return [3, 15];
                        proceedResponse = coordinatorResponse.proceed;
                        if (!(0, CoordinatorService_1.isProceedToClientRegistry)(proceedResponse)) return [3, 13];
                        clientRegistryPrincipal = proceedResponse.clientRegistry.canisterPrincipal;
                        return [4, this.recursiveCallClientRegistry(sdkVersion, clientRegistryPrincipal, CLIENT_REGISTRY_RETRIES)];
                    case 3:
                        clientRegistryResponse = _b.sent();
                        (0, utils_1.log)("recursive.callClientRegistry", clientRegistryResponse);
                        if (!(0, utils_1.isProceed)(clientRegistryResponse)) return [3, 6];
                        analyticsReceiverView = clientRegistryResponse.proceed;
                        if (!analyticsReceiverView) return [3, 5];
                        canisterPrincipal = analyticsReceiverView.canisterPrincipal, accessToken = analyticsReceiverView.accessToken;
                        return [4, this.recursiveCallAnalyticsStore(sdkVersion, canisterPrincipal, accessToken, ANALYTICS_STORE_RETRIES)];
                    case 4:
                        analyticsStoreResponse = _b.sent();
                        (0, utils_1.log)("recursive.callAnalyticsStore", analyticsStoreResponse);
                        return [2, analyticsStoreResponse];
                    case 5: return [2, clientRegistryResponse];
                    case 6:
                        if (!(0, utils_1.isOk)(clientRegistryResponse)) return [3, 7];
                        return [2, clientRegistryResponse];
                    case 7:
                        if (!(0, utils_1.isErr)(clientRegistryResponse)) return [3, 12];
                    ...
                    case 8:
                        ...
                        return [4, (0, utils_1.delayPromise)(timeout)];
                    case 9:
                        _b.sent();
                        return [4, this.recursiveCall(sdkVersion, retriesLeft - 1)];
                    ...
                    case 12: return [3, 15];
                    case 13:
                        if (!(0, CoordinatorService_1.isProceedToAnalyticsReceiver)(proceedResponse)) return [3, 15];
                        analyticsReceiverView = proceedResponse.analyticsReceiver.view;
                        if (!analyticsReceiverView) return [3, 15];
                        canisterPrincipal = analyticsReceiverView.canisterPrincipal, accessToken = analyticsReceiverView.accessToken;
                        return [4, this.recursiveCallAnalyticsStore(sdkVersion, canisterPrincipal, accessToken, ANALYTICS_STORE_RETRIES)];
                    case 14:
                        analyticsStoreResponse = _b.sent();
                        (0, utils_1.log)("recursive.callAnalyticsStore", analyticsStoreResponse);
                        return [2, analyticsStoreResponse];
                    case 15: return [2, (0, utils_1.createErrFatal)()];
                }
            });
        });
    };
    SessionFacade.prototype.recursiveCallCoordinator = function (sdkVersion, retriesLeft) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4, (0, CoordinatorService_1.getResult)(sdkVersion, this.apiKey, this.clientPrincipal)];
                    case 1:
                        coordinatorResponse = _b.sent();
                        (0, utils_1.log)("getResult.coordinator", coordinatorResponse, { retriesLeft: retriesLeft });
                        if (!(0, utils_1.isOk)(coordinatorResponse)) return [3, 2];
                        return [2, coordinatorResponse];
                    case 2:
                        if (!(0, utils_1.isProceed)(coordinatorResponse)) return [3, 3];
                        return [2, coordinatorResponse];
                    case 3:
                        if (!(0, utils_1.isErr)(coordinatorResponse)) return [3, 10];
                        _a = coordinatorResponse.err;
                        switch (_a) {
                            case "changeTopology": return [3, 4];
                            case "retry": return [3, 6];
                        }
                        return [3, 9];
                    case 4:
                    ...
                    case 5:
                        _b.sent();
                        return [2, this.recursiveCallCoordinator(sdkVersion, retriesLeft - 1)];
                    case 6:
                        if (!(retriesLeft > 0)) return [3, 8];
                        timeout = (0, exports.getTimeout)(COORDINATOR_RETRIES - retriesLeft);
                        (0, utils_1.log)("sleep for", timeout, "ms");
                        return [4, (0, utils_1.delayPromise)(timeout)];
                    case 7:
                    ...
                    case 9:
                        ...
                        _b.label = 10;
                    case 10: return [2, (0, utils_1.createErrFatal)()];
                }
            });
        });
    };
    SessionFacade.prototype.recursiveCallClientRegistry = function (sdkVersion, clientRegistryPrincipal, retriesLeft) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4, (0, ClientRegistryService_1.getResult)(sdkVersion, this.apiKey, this.clientPrincipal, clientRegistryPrincipal)];
                    case 1:
                        clientRegistryResponse = _b.sent();
                        (0, utils_1.log)("getResult.clientRegistry", clientRegistryResponse, { retriesLeft: retriesLeft });
                        if (!(0, utils_1.isProceed)(clientRegistryResponse)) return [3, 2];
                        return [2, clientRegistryResponse];
                    case 2:
                        if (!(0, utils_1.isOk)(clientRegistryResponse)) return [3, 3];
                        return [2, clientRegistryResponse];
                    case 3:
                        if (!(0, utils_1.isErr)(clientRegistryResponse)) return [3, 9];
                        _a = clientRegistryResponse.err;
                        switch (_a) {
                            case "retry": return [3, 4];
                            case "restart": return [3, 7];
                        }
                        return [3, 8];
                    case 4:
                        if (!(retriesLeft > 0)) return [3, 6];
                        timeout = (0, exports.getTimeout)(CLIENT_REGISTRY_RETRIES - retriesLeft);
                        (0, utils_1.log)("sleep for", timeout, "ms");
                        return [4, (0, utils_1.delayPromise)(timeout)];
                    case 5:
                        _b.sent();
                        return [2, this.recursiveCallClientRegistry(sdkVersion, clientRegistryPrincipal, retriesLeft - 1)];
                    case 6: return [3, 9];
                    case 7:
                        {
    ...
    SessionFacade.prototype.recursiveCallAnalyticsStore = function (sdkVersion, canisterPrincipal, accessToken, retriesLeft) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4, (0, AnalyticsStoreService_1.getResult)(sdkVersion, this.apiKey, this.clientPrincipal, canisterPrincipal, accessToken)];
                    case 1:
                        analyticsStoreResponse = _b.sent();
                        (0, utils_1.log)("getResult.analyticsStore", analyticsStoreResponse, { retriesLeft: retriesLeft });
                        if (!(0, utils_1.isOk)(analyticsStoreResponse)) return [3, 2];
                        return [2, analyticsStoreResponse];
                    case 2:
                        if (!(0, utils_1.isErr)(analyticsStoreResponse)) return [3, 7];
                        _a = analyticsStoreResponse.err;
                        switch (_a) {
                            case "retry": return [3, 3];
                        }
                        return [3, 6];
                    case 3:
                        if (!(retriesLeft > 0)) return [3, 5];
                        timeout = (0, exports.getTimeout)(ANALYTICS_STORE_RETRIES - retriesLeft);
                        (0, utils_1.log)("sleep for", timeout, "ms");
                        return [4, (0, utils_1.delayPromise)(timeout)];
                    case 4:
                        _b.sent();
                        return [2, this.recursiveCallAnalyticsStore(sdkVersion, canisterPrincipal, accessToken, retriesLeft - 1)];
                    case 5: return [3, 7];
                    case 6:
                        {
                            return [3, 7];
                        ...
                        _b.label = 7;
                    case 7: return [2, (0, utils_1.createErrFatal)()];
                }
            });
        });
    };
